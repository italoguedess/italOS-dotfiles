...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    ...
    loaded = true,
    path = "/home/italo/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  ["gitsigns.nvim"] = {
    loaded = true,
    path = "/home/italo/.local/share/nvim/site/pack/packer/start/gitsigns.nvim",
  ...
  ["nvim-treesitter-textobjects"] = {
    loaded = true,
    path = "/home/italo/.local/share/nvim/site/pack/packer/start/nvim-treesitter-textobjects",
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/home/italo/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
  ...
  vim = {
    loaded = true,
    path = "/home/italo/.local/share/nvim/site/pack/packer/start/vim",
  ...
  ["vim-gutentags"] = {
    loaded = true,
    path = "/home/italo/.local/share/nvim/site/pack/packer/start/vim-gutentags",
